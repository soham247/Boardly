    ...
    <section className="relative flex flex-col items-center justify-center min-h-[90vh] px-4 text-center overflow-hidden bg-background">
      ...
      <div className="max-w-5xl space-y-8 pt-20 pb-16">
        ...
        <div className="flex flex-col items-center gap-4 sm:flex-row sm:justify-center pt-8 animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-300">
          <Button
            size="lg"
            className="rounded-full h-12 px-8 text-base shadow-lg shadow-primary/20 hover:shadow-primary/30 transition-all hover:scale-105"
            asChild
          >
            <Link to={isAuthenticated ? '/workspaces' : '/signup'}>Get Started</Link>
          </Button>
          <Button
            variant="outline"
            size="lg"
            className="rounded-full h-12 px-8 text-base backdrop-blur-sm bg-background/50 hover:bg-accent/50 transition-all hover:scale-105 group"
          >
            Learn More
