...
export const BoardCardSkeleton = ({ viewMode }: { viewMode: 'grid' | 'list' }) => {
  ...
  if (viewMode === 'list') {
    return (
      <Card className="flex items-center justify-between p-4 px-6 h-20 rounded-xl bg-card border-border">
        {/* Left section */}{' '}
  ...
  return (
    <Card className="p-6 h-45 flex flex-col justify-between rounded-xl bg-card border-border">
      {/* top color bar */}
